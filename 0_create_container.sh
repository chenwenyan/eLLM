...
docker create --name vllm_dynamic --ipc=host -it -v /nfs/dataset:/nfs/dataset -v /nfs/cache:/nfs/cache -v /home/wychen/.cache:/root/.cache -v /home/wychen/workspace:/root/workspace -v /home/wychen/.cache/huggingface/hub:/root/.cache/huggingface/hub -v /nfs/cache/huggingface/hub/models--meta-llama--Llama-2-70b-hf:/root/.cache/huggingface/hub/models--meta-llama--Llama-2-70b-hf vllm_build:v1.1